...
def init_db():
    """Initializes and tests MySQL connection on startup."""
    ...
    try:
        ...
        # Execute database setup script if schema needs initialization
        schema_path = os.path.join(os.path.dirname(__file__), "database", "database_setup.sql")
